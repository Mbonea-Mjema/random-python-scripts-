...
url="https://www.dse.co.tz/?q=dse/market-report"

#CREATE A REQUEST
#Request_object=req(url,data=None,headers=None)

#OPEN THE URL 
#html=up(Request_object)
from requests import Session as Search
html=Search().get(url,verify=False)
...
#MARKET REPORT
pdf_raw=soup("a",{"class":"prev-reports"})
#print(pdf_raw)
