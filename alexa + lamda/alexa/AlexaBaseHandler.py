...
class AlexaBaseHandler(object):
    """
    Base class for a python Alexa Skill Set. AlexaDeploymentHandler implements the abstract methods of this class.
...
# Useful methods to find the slots,intents name, slots values
